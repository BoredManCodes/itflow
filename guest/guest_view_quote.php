...
$sql = mysqli_query(
    ...
    "SELECT client_currency_code, client_id, client_name, client_website, contact_email,
        ...
        quote_discount_amount, quote_discount_type, quote_expire, quote_id, quote_note, quote_number,
        quote_prefix, quote_status FROM quotes
                ...
                <table class="table table-hover mb-0">
                    ...
                    ?>
                        <tr>
                            ...
                            <td class="text-right"><?= numfmt_format_currency($currency_format, -$discount_display_amount, $quote_currency_code) ?></td>
                        </tr>
                    <?php } ?>
                    <?php if ($total_tax > 0) { ?>
                        <tr>
