...
--
-- Table structure for table `entra_tenants`
--

DROP TABLE IF EXISTS `entra_tenants`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
...
--
-- Table structure for table `entra_sync_contacts`
--

DROP TABLE IF EXISTS `entra_sync_contacts`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `entra_sync_contacts` (
...
--
-- Table structure for table `entra_sync_assets`
--

DROP TABLE IF EXISTS `entra_sync_assets`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8mb4 */;
CREATE TABLE `entra_sync_assets` (
...
CREATE TABLE `invoices` (
  ...
  `invoice_discount_type` enum('amount','percent') NOT NULL DEFAULT 'amount',
...
CREATE TABLE `quotes` (
  ...
  `quote_discount_type` enum('amount','percent') NOT NULL DEFAULT 'amount',
...
CREATE TABLE `recurring_invoices` (
  ...
  `recurring_invoice_discount_type` enum('amount','percent') NOT NULL DEFAULT 'amount',
...
CREATE TABLE `settings` (
  ...
  `config_phone_show_country_code` tinyint(1) NOT NULL DEFAULT 1,
  `config_phone_mask` varchar(30) NOT NULL DEFAULT '',
