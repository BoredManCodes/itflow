...
if (isset($_GET['invoice_id'])) {
    ...
    $sql = mysqli_query(
        ...
        "SELECT client_currency_code, client_id, client_name, client_net_terms, client_website,
            ...
            invoice_discount_amount, invoice_discount_type, invoice_due, invoice_id, invoice_note,
            invoice_number, invoice_prefix, invoice_scope, invoice_status, invoice_url_key,
                    ...
                    <table class="table table-hover mb-0">
                        ...
                        if ($invoice_discount > 0) {
                            ...
                            <tr>
                                ...
                                <td class="text-end">-<?= numfmt_format_currency($currency_format, $discount_display_amount, $invoice_currency_code) ?></td>
                            </tr>
                        <?php
                        }
                        ?>
                                ...
                                <tr>
                                    ...
                                    <?php if (lookupUserPermission("module_sales") >= 3 && lookupUserPermission("module_financial") >= 3) { ?>
                                        <td class="text-center">
                                            ...
                                            <?php } elseif ($payment_method == "Square") { ?>
                                                <a class="btn btn-light text-warning confirm-link" title="Refund Payment" href="post.php?refund_payment_square=<?= $payment_id ?>&csrf_token=<?= $_SESSION['csrf_token'] ?>"><i class="fa fa-undo"></i></a>
                                            <?php } ?>
